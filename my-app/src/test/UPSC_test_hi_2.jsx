...
import { UPSC_test_hi_2_questions } from "./UPSC_test_hi_2_que";

const UPSC_test_hi_2 = () => {
  ...
  const questions = UPSC_test_hi_2_questions;
  ...
  return (
    <div className="min-h-screen  py-6">
      {!details && (<div className="exam-container md:w-8/12 mx-auto bg-white rounded-xl shadow-lg p-8">
        <form
          className="w-md:6/12 mx-auto border p-3 rounded"
